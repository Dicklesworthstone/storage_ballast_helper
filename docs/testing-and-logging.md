...
| Target | Tests |
| --- | --- |
| `cargo test --lib` (default features, with the TUI) | 2594 |
| `cargo test --lib --no-default-features --features cli,daemon,sqlite` (lean) | 1614 |
...
| **Cargo tests on Linux, default features (lib + bin + integration)** | **3051** |
<!-- sbh-census:end -->
