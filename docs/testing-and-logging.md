...
The runbook runs 28 stages across 6 groups (21 HARD, 7 SOFT). HARD failures
block merge/release. SOFT failures require waivers. A `test` stage must
...
**Stage summary** (generated by `./scripts/quality-gate.sh --print-stages --markdown`; regenerate after editing the script):
