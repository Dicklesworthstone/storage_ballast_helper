...
| Target | Tests |
| --- | --- |
| `cargo test --lib` (default features, with the TUI) | 2574 |
| `cargo test --lib --no-default-features --features cli,daemon,sqlite` (lean) | 1606 |
...
| `cargo test --test dashboard_pty` | 2 |
...
| **Cargo tests on Linux, default features (lib + bin + integration)** | **3028** |
<!-- sbh-census:end -->
